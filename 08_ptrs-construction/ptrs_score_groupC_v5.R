#!/usr/bin/env Rscript
################################################################################
# ptrs_score_groupC_v5.R
#
# Per-chromosome PTRS scoring for one tissue / cell type, called by
# `ptrs_score_v5.sbatch`. For each significant gene in the chromosome, this
# script:
...
#
# Usage:
#   Rscript ptrs_score_groupC_v5.R \
