...
base_directory = "${PROJECT_DIR}/FOCUS/results/"
...
# Summary
# ---------------------------
print("====== FOCUS file integrity check ======")
...
# Save lists
# ---------------------------
with open("empty_focus_files.txt", "w") as f:
    for x in empty_files:
        f.write(x + "\n")

with open("error_focus_files.txt", "w") as f:
    for path, err in error_files:
        f.write(f"{path}\t{err}\n")

print("\nLists written to:")
print("  - empty_focus_files.txt")
print("  - error_focus_files.txt")
